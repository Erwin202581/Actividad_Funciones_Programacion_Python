# Clase Vehículo y subclases Auto/Moto 
...
class Auto(Vehiculo):
    ...
    def acelerar(self, incremento):
        ...
        return f"El Auto {self.marca} {self.modelo} rugió y aceleró a {self.velocidad:.2f} km/h."
...
class Moto(Vehiculo):
    ...
    def acelerar(self, incremento):
        ...
        return f"La Moto {self.marca} {self.modelo} se lanzó a {self.velocidad:.2f} km/h."
