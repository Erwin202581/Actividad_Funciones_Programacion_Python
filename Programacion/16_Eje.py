# Encapsulamiento Básico con `BankAccount` 
...
try:
    ...
    # Acceso 'interno' al atributo (por la técnica de name mangling de Python)
    ...
    # Demostrar validaciones (descomentar para probar los errores)
